...
final class Version20260402225532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE activite (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, decription LONGTEXT DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, duree INT DEFAULT NULL, lieu VARCHAR(100) DEFAULT NULL, image_url VARCHAR(255) DEFAULT NULL, ai_rating DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
