...
class Voyage
{
    ...
    // ✅ FIX : suppression du cascade="remove" qui conflicte avec onDelete="SET NULL"
    #[ORM\ManyToOne(targetEntity: Destination::class, inversedBy: "voyages")]
    #[ORM\JoinColumn(nullable: true, onDelete: "SET NULL")]
    private ?Destination $destination = null;

    // ✅ FIX : cascade="remove" aligné avec onDelete="CASCADE" sur Transport
    ...
    public function getReservedByUsers(): Collection { return $this->reservedByUsers; }
    public function addReservation(Users $user): static
    {
        if (!$this->reservedByUsers->contains($user)) $this->reservedByUsers->add($user);
        return $this;
    }
    ...
    public function isPaidByUser($user): bool { return false; }
    public function getReservedBy(): ?Users { return $this->reservedByUsers->first() ?: null; }

    public function isPaid(): bool { return $this->paid; }
    public function setPaid(bool $paid): static { $this->paid = $paid; return $this; }

    public function getHebergements(): Collection { return $this->hebergements; }
    ...
    {
        if ($this->hebergements->removeElement($hebergement)) $hebergement->removeVoyage($this);
        return $this;
    }
}