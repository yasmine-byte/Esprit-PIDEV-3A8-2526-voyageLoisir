...
class Destination
{
    ...
    // ✅ FIX 1 : suppression de cascade="remove" car onDelete="SET NULL" en BDD
    // Les voyages ne doivent pas être supprimés quand une destination est supprimée
    #[ORM\OneToMany(mappedBy: "destination", targetEntity: Voyage::class, cascade: ["persist"])]
    private Collection $voyages;

    // ✅ FIX 2 : ajout de onDelete="CASCADE" pour aligner avec cascade="remove"
