...
final class ReservationActiviteController extends AbstractController
{
    #[Route(name: 'app_reservation_activite_index', methods: ['GET'])]
    public function index(ReservationActiviteRepository $reservationActiviteRepository): Response
    {
        return $this->render('reservation_activite/index.html.twig', [
            'reservation_activites' => $reservationActiviteRepository->findAll(),
        ]);
    }
    ...
    public function new(Activite $activite, Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('reservation_activite/new.html.twig', [
    ...
    #[Route('/{id}', name: 'app_reservation_activite_show', methods: ['GET'])]
    ...
    public function edit(Request $request, ReservationActivite $reservationActivite, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('reservation_activite/edit.html.twig', [
            'reservation_activite' => $reservationActivite,
            'form' => $form,
        ]);
    }
